...
//    vector <int> test_scores (3, 100);       // 3 elements all initialized to 100
    ...
    cout << "\nThere are now " << test_scores.size() << " test scores in the vector." << endl;
    
//    cout << "This should cause an exception!!" << test_scores.at(10) << endl;         // throws an out of bounds exception
    ...
    cout << "\nHere are the movie ratings for reviewer #1 using the vector syntax: " << endl;
